...
describe('useCaminosColoreados', () => {
  ...
  describe('Data loading', () => {
    ...
    it('catches BooleanLiteral mutation: response.ok check is critical', async () => {
    ...
    it('catches StringLiteral mutation: error prefix text must be correct', async () => {
      ...
      // If error message string is mutated, this will fail
