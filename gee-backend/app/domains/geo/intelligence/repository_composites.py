...
class IntelligenceRepositoryCompositesMixin:
    ...
    def get_composite_stats_by_area(
        self, db: Session, area_id: str, tipo: Optional[str] = None
        ...
        items = list(
            db.execute(stmt.order_by(CompositeZonalStats.mean_score.desc()))
            .scalars()
            .unique()
            .all()
        )
        ...
        return list(
            db.execute(fallback_stmt.order_by(CompositeZonalStats.mean_score.desc()))
            .scalars()
            .unique()
            .all()
        )
    ...
    def get_suggestions_by_tipo(
        ...
        *,
        ...
        return self._paginated_results(
            db, base, page=page, limit=limit, order_by=CanalSuggestion.score.desc()
        )
    ...
    def get_summary(
        self, db: Session, batch_id: Optional[uuid.UUID] = None
