...
class GeoRoutingScenario(UUIDMixin, TimestampMixin, Base):
    ...
    previous_version_id: Mapped[uuid.UUID | None] = mapped_column(
        UUID(as_uuid=True),
        ForeignKey("geo_routing_scenarios.id"),
        nullable=True,
    )
...
class GeoRoutingScenarioApprovalEvent(UUIDMixin, Base):
    """Audit trail for approve/unapprove actions on corridor scenarios."""

    __tablename__ = "geo_routing_scenario_approval_events"
